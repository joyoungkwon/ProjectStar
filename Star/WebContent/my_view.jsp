...
<body>
	...
	<div class="sort_div" class="container text-center">
		<div class="sort"></div>
		<select onchange="select_toggle()" class="small-select form-select form-select-sm" aria-label="Small select example">
			<option>전체보기</option>
			<option>비공개</option>
		</select>
	</div>
	...
	<!-- board_container 닫기 -->
	<script type="text/javascript" src="resources/js/my_view.js"></script>
